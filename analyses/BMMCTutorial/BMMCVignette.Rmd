...
```{r, include = FALSE}
Uncomment below to run docker environment
RHOME=/home/rstudio
SCRATCH1=/mnt/d/garyw/scratch
docker run -it \
--cpus=14 \
--memory="600g" \
--workdir $HOME \
--name dturtle \
-v /mnt/g/Atlas_References:$HOME/Atlas_References \
...
-v $HOME:$HOME \
-v /mnt/g/Atlas_References:$RHOME/Atlas_References \
-v /mnt/g/spaceranger_visium_counts:$RHOME/spaceranger_visium_counts \
-v /mnt/g/ckd:$RHOME/ckd \
-v /mnt/g/:$RHOME/g \
-v /mnt/e/:$RHOME/e \
...
source(here(code_dir,"getCounts.R"))
source(here(code_dir,"getBias.R"))
source(here(code_dir,"getFootprints.R")) 
source(here(code_dir,"getSubstructures.R"))
source(here(code_dir,"visualization.R"))
source(here(code_dir,"getGroupData.R"))
source(here(code_dir,"footprintTracking.R"))
source(here(code_dir,"getTFBS.R"))
```
